  ...
  return (
    <header className="fixed w-full z-50">
      ...
      <Link href="/" aria-label="Ir para a página inicial/home">
        <div className="fixed left-1/2 -translate-x-1/2 z-[9990] hidden lg:block" style={{ top: 'calc(1.85rem + 4px)' }}>
          <Image
            ...
            width={200}
            height={50}
            className="scale-120 mix-blend-difference !w-full !h-full !max-w-full !m-0 !p-0"
            priority />
