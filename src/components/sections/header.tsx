  ...
  return (
    <>
      ...
      <header className="fixed w-full z-50">
        {/* Desktop Header - Layout ajustado para simetria */}
        <div className="hidden lg:flex fixed top-0 left-0 right-0 h-[80px] items-center justify-center px-8 xll:px-12 z-50">
          ...
          <div className="w-full max-w-[1400px] flex items-center justify-between">
            ...
            {/* Center Logo - Lado Central */}
            <div className="flex-shrink-0 mx-8 xl:mx-12">
